...
(function($) {
	...
	var init = function(opt) {	
		...
		jQuery(window).resize(function() {
			clearTempsout(opt.sliced_resize_Tempsr);
			opt.sliced_resize_Tempsr = setTempsout(function() {
			for (var i in opt.slidecobjects) {	
				var l = opt.slidecobjects[i].caption,
	...
	var animateSlicedBox = function(l,ls,prog) {		
		if (ls.slicedbox_wrapper.length>0) {			
			...
			_.slicedanimation = new punchgs.TempslineLite();				
			...
			_.slicedanimation.add(punchgs.TweenLite.DeTo(ls.slicedbox_wrapper,_.global_duration,
											{	z:0,
												x:_.x.start,
												y:_.y.start,
